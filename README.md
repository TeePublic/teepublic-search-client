...
*SwaggerClient::SearchApi* | [**post_v1_category_search**](docs/SearchApi.md#post_v1_category_search) | **POST** /v1/category-search | Endpoint to retrieve discoverable designs associated with a given category.
...
## Documentation for Models
 ...
 - [SwaggerClient::CategorySearchRequestV1](docs/CategorySearchRequestV1.md)
