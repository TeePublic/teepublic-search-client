...
# Unit tests for SwaggerClient::SimilarDesignsRequestV1
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'SimilarDesignsRequestV1' do
  before do
    # run before each test
    @instance = SwaggerClient::SimilarDesignsRequestV1.new
  end
  ...
  describe 'test an instance of SimilarDesignsRequestV1' do
    it 'should create an instance of SimilarDesignsRequestV1' do
      expect(@instance).to be_instance_of(SwaggerClient::SimilarDesignsRequestV1)
    end
  end
  describe 'test attribute "ref_design_id"' do
    it 'should work' do
