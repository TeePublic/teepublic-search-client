...
# Unit tests for SwaggerClient::CategorySearchRequestV1
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CategorySearchRequestV1' do
  before do
    # run before each test
    @instance = SwaggerClient::CategorySearchRequestV1.new
  end
  ...
  describe 'test an instance of CategorySearchRequestV1' do
    it 'should create an instance of CategorySearchRequestV1' do
      expect(@instance).to be_instance_of(SwaggerClient::CategorySearchRequestV1)
    end
  end
  ...
  describe 'test attribute "canvas"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
