  ...
  class TagApi
    ...
    def get_v1_link_graph_with_http_info(tag_name, opts = {})
      ...
      if @api_client.config.client_side_validation && tag_name.nil?
        fail ArgumentError, "Missing the required parameter 'tag_name' when calling TagApi.get_v1_link_graph"
      end
      # resource path
      local_var_path = '/v1/link-graph'
    ...
    def post_v1_link_graph(body, opts = {})
      data, _status_code, _headers = post_v1_link_graph_with_http_info(body, opts)
      data
    end
    ...
    # @param body request body
    # @param [Hash] opts the optional parameters
    # @return [Array<(SetLinkGraphResponse, Fixnum, Hash)>] SetLinkGraphResponse data, response status code and response headers
    def post_v1_link_graph_with_http_info(body, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: TagApi.post_v1_link_graph ...'
      end
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling TagApi.post_v1_link_graph"
      end
      # resource path
      local_var_path = '/v1/link-graph'
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'SetLinkGraphResponse')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: TagApi#post_v1_link_graph\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
