...
module SwaggerClient
  # User search request.
  class SimilarDesignsRequestV1
    # reference design id
    attr_accessor :ref_design_id
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'ref_design_id')
        self.ref_design_id = attributes[:'ref_design_id']
      end
    ...
    def hash
      [ref_design_id, search_terms, sort, tags_filter, canvases, artist_filter, per_page, page_offset, explain, es_explain, relevancy_config_id, bucket, safe_search].hash
    end
