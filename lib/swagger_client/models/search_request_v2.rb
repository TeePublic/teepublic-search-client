...
module SwaggerClient
  ...
  class SearchRequestV2
    ...
    def hash
      [search_terms, sort, tags_filter, canvases, artist_filter, per_page, page_offset, explain, es_explain, relevancy_config_id, bucket, did_you_mean, safe_search, type].hash
    end
