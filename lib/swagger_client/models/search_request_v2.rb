...
module SwaggerClient
  ...
  class SearchRequestV2
    ...
    # Relevancy config id.
    attr_accessor :relevancy_config_id

    # AB test bucket.
    attr_accessor :bucket

    # whether we include did you mean suggestions in search results.
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'relevancy_config_id')
        self.relevancy_config_id = attributes[:'relevancy_config_id']
      end
      ...
      if attributes.has_key?(:'did_you_mean')
        self.did_you_mean = attributes[:'did_you_mean']
      else
        self.did_you_mean = true
      end
    ...
    def valid?
      sort_validator = EnumAttributeValidator.new('String', ['relevance', 'popular', 'newest', 'trending'])
      return false unless sort_validator.valid?(@sort)
      type_validator = EnumAttributeValidator.new('String', ['category-search', 'site-search', 'tag-page'])
    ...
    def sort=(sort)
      validator = EnumAttributeValidator.new('String', ['relevance', 'popular', 'newest', 'trending'])
    ...
    def type=(type)
      validator = EnumAttributeValidator.new('String', ['category-search', 'site-search', 'tag-page'])
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          relevancy_config_id == o.relevancy_config_id &&
          bucket == o.bucket &&
    ...
    def hash
      [search_terms, sort, tags_filter, canvases, artist_filter, per_page, page_offset, explain, es_explain, relevancy_config_id, bucket, did_you_mean, safe_search, type, promoted_filters].hash
    end
