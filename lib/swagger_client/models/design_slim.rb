...
module SwaggerClient
  ...
  class DesignSlim
    ...
    # Unique identifier of the design's creator.
    attr_accessor :artist_slug

    # Name of the store that houses this design.
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'artist_slug')
        self.artist_slug = attributes[:'artist_slug']
      end
      ...
      if attributes.has_key?(:'fam_approved')
    ...
    def hash
      [id, title, artist_slug, artist_name, primary_tag, primary_related_tags, secondary_tags, sales, fam_approved, click_through_rate, explanation].hash
    end
