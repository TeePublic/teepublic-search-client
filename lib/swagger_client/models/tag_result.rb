...
module SwaggerClient
  class TagResult
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'child_count')
    ...
    def hash
      [_id, name, taggings, discoverable_taggings, mature, suggestable, canonical, relatable, deleted, child_count, parent_name].hash
    end
