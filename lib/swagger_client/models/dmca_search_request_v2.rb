...
module SwaggerClient
  class DmcaSearchRequestV2
    # Designs that have been approved by TeePublic and are searchable
    attr_accessor :teepublic_approved

    # Designs not approved by TeePublic that are filtered out of search but are
    # still accessible through stores and have product pages
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'teepublic_approved')
        self.approved_filter = attributes[:'teepublic_approved']
      end

      if attributes.has_key?(:'teepublic_unapproved')
        self.approved_filter = attributes[:'teepublic_unapproved']
      end
