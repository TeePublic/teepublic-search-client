  ...
  class SearchRequest
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'product_type')
        ...
        self.product_type = 'classic-t-shirt'
      end

      if attributes.has_key?(:'artist_filter')
        self.artist_filter = attributes[:'artist_filter']
      end
    ...
    def valid?
      ...
      gender_validator = EnumAttributeValidator.new('String', ['mens', 'womens', 'unisex'])
    ...
    def gender=(gender)
      validator = EnumAttributeValidator.new('String', ['mens', 'womens', 'unisex'])
    ...
    def hash
      [search_terms, sort, tags_filter, gender, product_type, artist_filter, per_page, page_offset, explain].hash
    end
